...
{  
    ...
    void questionset()  
    {
        ...
        {  
            ...
            l.setText("Que1: How many legs does a human have?");  
            jb[0].setText("one");jb[1].setText("Two");jb[2].setText("three");jb[3].setText("zero"); 
            lblNewLabel_x.setText("level: easy");
            lblNewLabel_y.setText("marks: 3");
        }  
        if(question_number==1)  
        {  
            l.setText("Que2: Which of the following is a wild animal?");  
            jb[0].setText("Dog");jb[1].setText("Cat");jb[2].setText("Lion");jb[3].setText("None of the above");
            lblNewLabel_x.setText("level: easy");
            lblNewLabel_y.setText("marks: 3");
        }  
        if(question_number==2)  
        {  
            l.setText("Que3: What is sum of 2 and 2?");  
            jb[0].setText("1.0");jb[1].setText("2.0");jb[2].setText("undefined");jb[3].setText("4.0");
            lblNewLabel_x.setText("level: easy");
            lblNewLabel_y.setText("marks: 3");
        }  
        ...
        {  
            l.setText("Que7: Which one among these sorting algorithms will have minimum time complexity? ");  
            jb[0].setText("insertion sort");jb[1].setText("Merge sort");jb[2].setText("quick sort");  jb[3].setText("Heap sort");  
            lblNewLabel_x.setText("level: medium");
            lblNewLabel_y.setText("marks: 4"); 
        ...
        {  
            l.setText("Que9: Which among the following is linear data structure?");  
            jb[0].setText("Array");jb[1].setText("Avl trees");jb[2].setText("Binary trees");jb[3].setText("graphs"); 
            lblNewLabel_x.setText("level: hard");
            lblNewLabel_y.setText("marks: 5");
        }  
        if(question_number==9)  
        {  
            l.setText("Que10: Which one among these is not a type of queue");  
            jb[0].setText("Priority queue");jb[1].setText("Circular queue");jb[2].setText("Single-ended queue"); jb[3].setText("Ordinary queue");   
            lblNewLabel_x.setText("level: hard");
            lblNewLabel_y.setText("marks: 5");
        }  
