...
public class Student_info extends JFrame {
	...
	public Student_info() {
		...
		nameList = new ArrayList<String>(); nameList.add("narayana");nameList.add("uday");nameList.add("komal"); nameList.add("oom");
		passList = new ArrayList<String>();  passList.add("abcabc"); passList.add("abcabc"); passList.add("abcabc"); passList.add("abcabc");
		idList = new ArrayList<String>(); idList.add("iib2021026"); idList.add("iib2021035");idList.add("iit2021227"); idList.add("iit2021300");
		...
		contentPane.setBackground(Color.decode("#41E5C4"));
